            ...
            <div class="relative flex h-auto justify-center flex-wrap">
                @foreach ($playlists as $playlist)
                    @if ($playlist->status == '1')
                        ...
                        <iframe width="560" height="315" src="{{ $playlist->url_playlist }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </iframe >
                    @endif
                @endforeach
            </div>
